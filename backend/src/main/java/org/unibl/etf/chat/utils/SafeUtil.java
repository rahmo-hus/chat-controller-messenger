package org.unibl.etf.chat.utils;
...
//            "(?i)(.*)(\\b)+SELECT(\\b)+\\s.*(\\b)+FROM(\\b)+\\s.*(.*)",
    ...
    public static boolean isXSSSafe(String dataString){
        return dataString.matches(XSS_REGEX_1) || dataString.matches(XSS_REGEX_2) || dataString.matches(XSS_REGEX_3);
    }
